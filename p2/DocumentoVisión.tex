...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.15\linewidth}p{0.1\linewidth}p{0.4\linewidth}p{0.25\linewidth}}
    ...
    \midrule
    07/Oct/2019 & 1.0 & Propuesta inicial del documento & MVG LMC MAP PMFC\\
    \bottomrule
  \end{tabular}
\end{table}
\newpage
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.35\linewidth}|p{0.65\linewidth}}
    ...
    \textbf{Responsabilidades} & Este stakeholder no tiene ninguna responsabilidad, aunque intentarán esforzarse para mejorar sus paquetes de viajes y actividades para que nuestra app no tenga lugar en el mercado. \\
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.35\linewidth}|p{0.65\linewidth}}
    \toprule
    \textbf{Descripción} & Los programadores son el grupo encargado de realizar la parte técnica de la aplicación, es decir, tanto el frontend como el backend, aunque dentro de estas dos categorías encontramos varios grupos, su éxito y responsabilidades son parecidas\\ 
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.35\linewidth}|p{0.65\linewidth}}
    ...
    \textbf{Criterios de éxito} & Su éxito se medirá una vez salga el producto. Si en un breve período de tiempo un gran número de personas están registradas y usan la aplicación querrá decir que la campaña causó efecto sobre los usuarios. \\
    \bottomrule
  \end{tabular}
\end{table}
