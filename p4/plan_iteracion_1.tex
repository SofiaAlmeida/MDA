...
\begin{longtable}{p{0.18\linewidth}|p{0.4\linewidth}|p{0.18\linewidth}|p{0.2\linewidth}}
  ...
  Tarea \ref{hu:registro} - 2 & Crear comando para intertar el usuario en la base de datos & 1 & SAB\\
  Tarea \ref{hu:registro} - 3 & Crear la interfaz de usuario & 2 & LMC\\
  Tarea \ref{hu:registro} - 4 & Realizar pruebas de aceptación & 4 & PFC \\
  Tarea \ref{hu:registro} - 5 & Crear documentación & 3 & MAP\\
  \bottomrule
\end{longtable}
\vspace{-0.5cm}
...
\begin{longtable}{p{0.18\linewidth}|p{0.5\linewidth}|p{0.1\linewidth}|p{0.2\linewidth}}
  ...
  Tarea \ref{hu:ver_publicaciones} - 2 & Realizar la interfaz de usuario & 4:30 & MAP\\
  Tarea \ref{hu:ver_publicaciones} - 3 & Realizar pruebas de aceptación & 2:20 & LMC\\
  \bottomrule
\end{longtable}
\vspace{-0.5cm}
\begin{longtable}{p{1.028\linewidth}}
...
\begin{longtable}{p{0.18\linewidth}|p{0.4\linewidth}|p{0.18\linewidth}|p{0.2\linewidth}}
  \toprule
  \textbf{Identificador} & \textbf{Título de la tarea de desarrollo} & \textbf{Est. (horas)} & \textbf{Desarrollador} \\
  Tarea \ref{hu:filtrar}.1 - 1 & Realizar diseño de la interfaz que permita incluir o excluir lugares & 6 & SAB\\
  Tarea \ref{hu:filtrar}.1 - 2 & Consultar base de datos & 1/2 & PFC\\
  Tarea \ref{hu:filtrar}.1 - 3 & Realizar pruebas de aceptación & 1 & LMC \\
  Tarea \ref{hu:filtrar}.1 - 4 & Crear documentación & 3 & MVGP\\
...
\begin{longtable}{p{0.18\linewidth}|p{0.4\linewidth}|p{0.18\linewidth}|p{0.2\linewidth}}
  ...
  Tarea \ref{hu:filtrar}.2 - 2 & Añadir a la interfaz un calendario para poder filtrar por fecha & 1 & MAP\\
  Tarea \ref{hu:filtrar}.2 - 3 & Realizar pruebas de aceptación & 3 & MVGP\\
  Tarea \ref{hu:filtrar}.2 - 4 & Integrar con el resto de filtros & 1/2 & PFC\\
  \bottomrule
\end{longtable}
\vspace{-0.5cm}
\begin{longtable}{p{1.028\linewidth}}
...
\begin{longtable}{p{0.18\linewidth}|p{0.4\linewidth}|p{0.18\linewidth}|p{0.2\linewidth}}
  ...
  Tarea \ref{hu:filtrar}.3 - 2 & Realizar las pruebas de aceptación & 1 & MAP\\
  Tarea \ref{hu:filtrar}.3 - 3 & Realizar la búsqueda en la base de datos & 2 & SAB \\
...
\begin{longtable}{p{0.18\linewidth}|p{0.4\linewidth}|p{0.18\linewidth}|p{0.2\linewidth}}
  \toprule
  \textbf{Identificador} & \textbf{Título de la tarea de desarrollo} & \textbf{Est. (horas)} & \textbf{Desarrollador} \\
  Tarea \ref{hu:filtrar}.4 - 1 & Realizar diseño de la interfaz que permita incluir o excluir lugares & 6 & SAB\\
  Tarea \ref{hu:filtrar}.4 - 2 & Implementar la búsqueda en la base de datos & 1/2 & MAP \\
  Tarea \ref{hu:filtrar}.4 - 3 & Realizar pruebas de aceptación & 2 & MVGP\\
  Tarea \ref{hu:filtrar}.4 - 4 & Crear documentación & 2 & LMC\\
  Tarea \ref{hu:filtrar}.4 - 5 & Integrar con el resto de filtros & 1/2 & PFC\\
  \bottomrule
\end{longtable}
\vspace{-0.5cm}
\begin{longtable}{p{1.028\linewidth}}
...
\begin{longtable}{p{0.18\linewidth}|p{0.4\linewidth}|p{0.18\linewidth}|p{0.2\linewidth}}
  \toprule
  \textbf{Identificador} & \textbf{Título de la tarea de desarrollo} & \textbf{Est. (horas)} & \textbf{Desarrollador} \\
  Tarea \ref{hu:personalizar}.1 - 1 & Diseño de la interfaz, añadiendo una X al lado de cada actividad & 2 & MVGP\\
  Tarea \ref{hu:personalizar}.1 - 2 & Modificar la ruta en la base de datos & 2 & MAP\\
  Tarea \ref{hu:personalizar}.1 - 3 & Pruebas de aceptación & 1 & SAB\\
  \bottomrule
\end{longtable}
\vspace{-0.5cm}
\begin{longtable}{p{1.028\linewidth}}
...
\begin{longtable}{p{0.18\linewidth}|p{0.4\linewidth}|p{0.18\linewidth}|p{0.2\linewidth}}
  ...
  Tarea \ref{hu:seleccionar} - 4 & Crear documentación & 1/2 & MAP\\
