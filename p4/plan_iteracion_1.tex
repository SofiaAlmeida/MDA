...
\begin{itemize}
\item \textbf{HU-\ref{hu:buscar}}. Un usuario quiere buscar una publicación a partir de un texto.
\item \textbf{HU-\ref{hu:ver_datos}}. Un usuario quiere ver su información personal.
\item \textbf{HU-\ref{hu:modificar_datos}}. Un usuario quiere modificar sus datos personales.
\item \textbf{HU-\ref{hu:marcar_realizado}}. Un usuario quiere indicar que ha realizado una actividad.
\item \textbf{HU-\ref{hu:cerrar_sesion}}. Un usuario desea cerrar la sesión en la aplicación.
\item \textbf{HU-\ref{hu:ver_publicadas}}. Un usuario quiere ver sus propias publicaciones.
\item \textbf{HU-\ref{hu:eliminar_deseo}}. Un usuario quiere eliminar una actividad de su lista de deseos.
\item \textbf{HU-\ref{hu:eliminar_voy_a_realizar}}. Un usuario desea eliminar una actividad de su lista de actividades a realizar.
\item \textbf{HU-\ref{hu:recuperar_contraseña}}. Un usuario ha olvidado su contraseña y desea poder recuperarla.
\item \textbf{HU-\ref{hu:saber_mas}}. Un usuario desea conocer más información sobre una publicación en particular.
\item \textbf{HU-\ref{hu:sobre_nosotros}}. Un usuario quiere saber más informacón sobre quién ha desarrollado la aplicación.
\item \textbf{HU-\ref{hu:ayuda}}. Un usuario desea ver una guía sobre el uso de la aplicación.
\item \textbf{HU-\ref{hu:eliminar_publicacion}}. Un usuario desea eliminar una publicación que ha subido. 
\item \textbf{HU-\ref{hu:modificar_publicacion}}. Un usuario desea modificar una publicación que ha subido
\item \textbf{HU-\ref{hu:ver_realizar}}. Un usuario quiere ver la lista de publicaciones a realizar.
\item \textbf{HU-\ref{hu:ver_realizadas}}.  Un usuario desea ver su lista de publicaciones ya realizadas. 
\end{itemize}
