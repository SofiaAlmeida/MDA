...
\begin{frame}
	\begin{center}
		%\includegraphics[angle=90, scale=0.33]{papel2_2}
	\end{center}
\end{frame}
...
\begin{frame}
	\begin{center}
	%	\includegraphics[angle=180, scale=0.32]{papel2_3}
	\end{center}
\end{frame}
...
\begin{frame}
	\begin{center}
	%	\includegraphics[angle=90, scale=0.34]{papel2_4}
	\end{center}
\end{frame}
...
\begin{frame}
	\begin{center}
	%	\includegraphics[angle=90, scale=0.335]{papel2_5}
	\end{center}
\end{frame}
...
\begin{frame}
	\begin{center}
	%	\includegraphics[angle=0, scale=0.34]{papel2_6}
	\end{center}
\end{frame}
...
\begin{frame}
	\begin{center}
	%	\includegraphics[scale=0.34]{papel2_7}
	\end{center}
\end{frame}
...
\begin{frame}
	\begin{center}
	%	\includegraphics[angle=90, scale=0.34]{papel2_8}
	\end{center}
\end{frame}
