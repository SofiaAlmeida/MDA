...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.12\linewidth}p{0.68\linewidth}p{0.15\linewidth}p{0.15\linewidth}}
    ...
    \hu{} & Un socio quiere ver información del Granada FC para estar al tanto & 1 & 2\\
    \hu{} & Como socio quiero entrar en la APP para ver si he ganado la quieniela & 1 & 2\\
    \hu{} & Como abonado quiero ver los viajes que tiene previsto la peña para acompañar al club & 2 & 3\\
    \bottomrule
  \end{tabular}
\end{table}
