...
En este documento veramos los 5 procesos que hay que seguir para aplicar FDD, las ventajas de esta metodología, los roles con sus respectivas responsabilidades y las prácticas propias de esta metodología.
...
El \textit{Feature Team} realiza una inspección del código antes del \textit{testing} unitario y cuando el código ha sido implementado e inspeccionado, el \textit{Class Owner} realiza un \textit{check-in} al \textit{Configuration Management System}\footnote{Repositorio en el cual se almacena toda la información del proyecto como ser documentación, código fuente, etc.}. Luego se realiza un \textit{main build} en el cual se hace la integración con las funcionalidades antes realizadas. Finalmente se realizan las pruebas de integración correspondiente.
...
\item \textit{Chief Programmer}. Es un programador con cierta experiencia ya que ha pasado por todo el proceso de desarrollo varias veces. Se encarga del análisis de requisitos a un alto nivel, de actividades relacionadas con el diseño y de la dirección de equipos pequeños (3 a 6 programadores) para el análisis, diseño y desarrollo de nuevas características. También escoge las características a desarrollar de la lista, identifica las clases y el \textit{Class Owner} que se necesita en el equipo para la
iteración. Con la ayuda de otros \textit{Chief Programmers} resuelve problemas técnicos y de recursos, y sigue el progreso
del equipo.
\item \textit{Class Owner}. Trabaja bajo la dirección del \textit{Chief Programmer} en tareas de diseño, programación, pruebas y documentación. Es el responsable de las clases que se le asignaron y participa en la decisión de qué clase será incluida en la lista de características de la próxima iteración.
