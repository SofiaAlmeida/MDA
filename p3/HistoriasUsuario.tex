...
La velocidad del equipo de desarrollo medido en puntos de historia es:  

5 programadores * 6 = 30 días reales por iteración $\Longrightarrow$ de 10 a 15 PH por iteración.  
Se ha decidido usar 12 puntos de historia (PH) como la velocidad estimada del equipo. 
...
\begin{itemize}
	...
	\item \textbf{Entrega 3:} (29 de Diciembre de 2019) Implementación de funcionalidades adicionales como grabar un audioguía y el vestuario. Correspondiente con las iteraciones 3 y 4.
